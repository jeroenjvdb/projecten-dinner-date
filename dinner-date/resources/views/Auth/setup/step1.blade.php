...
@section('body')
    ...
    <div class="row setup bg-white">
        <div class="form-horizontal">
            <div class="row">
                <h2 class="col-sm-offset-1">Profile info</h2>
                <p class="col-sm-offset-1 col-sm-9"> Before you can go find your perfect Dinner Date, we ask you to fill in a few questions.
                    A few for your profile. <br>
                    And a few to help you find your dinner date.
                </p>
            </div>
            ...
            {!! Form::open(array('url' => route('step1.post'), 'method' => 'post')) !!}
            ...
            <div class="form-group ">
                ...
                <div class="{{ $errors->has('searchFor') ? ' has-error' : '' }}">
                    {!! Form::label('searchFor', 'I search', ['class' => 'col-sm-3 control-label']) !!}
                    <div class="col-sm-3">
                        {!! Form::radio('searchFor', '0', false,['checked' => 'checked','id'=>'sman']) !!}
                        {!! Form::label('sman', 'male') !!}</br>
                        {!! Form::radio('searchFor', '1',false,['id'=>'sfemale']) !!}
